...
![选项界面](../images/zh/8.png)

### 更新账号密码

![更新账号密码界面](../images/zh/9.png)

用于更新美的美居账号密码。如果密码已更改，请在此更新。

### 同步云端设备信息

![同步设备信息界面](../images/zh/10.png)
