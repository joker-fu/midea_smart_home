            ...
            Platform.SELECT: {
                "program": {
                    "options": {
                        ...
                        "shirt": {"program": "shirt"},
                        "sterilize": {"program": "sterilize"},
                        "quick_dry_3kg": {"program": 127, "control_only": {"useCycleValue": 1}},
                        "wool": {"program": "wool"},
                        "jacket": {"program": 60, "control_only": {"useCycleValue": 1}},
                        "hot_air_dry": {"program": "hot_air_dry"},
                        "cold_air_fresh_air": {"program": "cold_air_fresh_air"},
                        "sterilize_remove_mite": {"program": 83, "control_only": {"useCycleValue": 1}},
                        "sun_quilt": {"program": "sun_quilt"},
                        "steam_care": {"program": "steam_care"},
                        "jacket_care": {"program": 81, "control_only": {"useCycleValue": 1}},
                        "silk": {"program": "silk"},
                        "shirt_care": {"program": 68, "control_only": {"useCycleValue": 1}},
                        "trench_coat_care": {"program": 67, "control_only": {"useCycleValue": 1}},
                        "small_piece_dry": {"program": "small_piece_dry"},
                        "quick_dry": {"program": "quick_dry"},
                        "cotton": {"program": "cotton"},
                        "towel": {"program": "towel"},
                        "jean": {"program": "jean"},
                        "trench_coat": {"program": 123, "control_only": {"useCycleValue": 1}},
                        "steam_bucket_self_clean": {"program": "bucket_self_clean"},
                        "pet_remove_mite": {"program": 82, "control_only": {"useCycleValue": 1}},
                        "woolen": {"program": 121, "control_only": {"useCycleValue": 1}},
                        "wool_coat": {"program": 78, "control_only": {"useCycleValue": 1}},
                        "seasonal_refresh": {"program": 89, "control_only": {"useCycleValue": 1}}
                    }
                },
                "intensity": {
